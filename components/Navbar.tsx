...
const Navbar = () => {
  ...
  return (
    <nav
      className="fixed top-0 z-20  flex h-12 w-full max-w-xl items-center justify-between bg-gradient-to-b  from-white
     via-white pt-4 text-center dark:from-bgdark dark:via-bgdark  max-sm:px-4"
    >
